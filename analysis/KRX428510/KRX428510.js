const labels = {
    ko: {
        heroTitle: "KODEX 차이나AI테크액티브 ETF 분석",
        heroCopy: "중국·홍콩 AI 미디어·테크, AI 반도체, PCB/패키징, 광통신, 메모리/파운드리 밸류체인을 NAV와 보유종목 관점에서 보는 정적 ETF 분석 페이지입니다.",
        dataStatus: "데이터 기준",
        latestClose: "확정 종가",
        feeLabel: "보수 / 분배",
        viewState: "현재 판단",
        viewStateSub: "중국 AI 테크 테마와 액티브 운용 품질 확인 구간",
        ...
        support: "지지",
        resistance: "저항",
        viewStateValue: "AI 테크 급등 후 추적 품질 확인",
        drivers: "동인",
        risks: "리스크",
        relevance: "노출",
        themeToggle: "테마 전환"
    ...
    en: {
        heroTitle: "KODEX China AI Tech Active ETF Analysis",
        heroCopy: "A static ETF analysis page for China AI media, semiconductor, PCB/substrate, optical networking and foundry value-chain exposure through NAV and holdings context.",
        dataStatus: "Data As Of",
        latestClose: "Confirmed Close",
        feeLabel: "Fee / Distribution",
        viewState: "Current View",
        viewStateSub: "China AI tech theme and active tracking quality check zone",
        chartEyebrow: "Price Action",
        ...
        viewStateValue: "AI tech rally with tracking quality check",
        drivers: "Drivers",
        risks: "Risks",
        relevance: "Exposure",
    ...
    ja: {
        heroTitle: "KODEX China AI Tech Active ETF 分析",
        heroCopy: "中国AIメディア、半導体、PCB/基板、光通信、ファウンドリのバリューチェーンを、NAVと保有銘柄の観点から見る静的ETF分析ページです。",
        dataStatus: "データ基準",
        latestClose: "確認済み終値",
        feeLabel: "費用 / 分配",
        viewState: "現在の見方",
        viewStateSub: "中国AIテックテーマとアクティブ運用品質の確認ゾーン",
        chartEyebrow: "Price Action",
        chartTitle: "ETF価格推移",
        profileEyebrow: "ETF Profile",
        ...
        support: "支持",
        resistance: "抵抗",
        viewStateValue: "AIテック急騰後に追随品質を確認",
        drivers: "ドライバー",
        risks: "リスク",
        relevance: "エクスポージャー",
        themeToggle: "テーマ切替"

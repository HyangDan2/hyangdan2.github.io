const labels = {
    ko: {
        heroTitle: "KODEX 차이나AI반도체TOP10 ETF 분석",
        heroCopy: "중국 AI 반도체, 광모듈, 파운드리 국산화 테마를 압축 포트폴리오와 NAV 관점에서 보는 정적 ETF 분석 페이지입니다.",
        dataStatus: "데이터 기준",
        latestClose: "확정 종가",
        feeLabel: "보수 / 분배",
        viewState: "현재 판단",
        viewStateSub: "NAV와 가격 괴리 확인 구간",
        ...
        support: "지지",
        resistance: "저항",
        viewStateValue: "상승 추세 속 NAV 괴리 확인",
        drivers: "동인",
        risks: "리스크",
        relevance: "노출",
        themeToggle: "테마 전환"
    ...
    en: {
        heroTitle: "KODEX China AI Semiconductor TOP10 ETF Analysis",
        heroCopy: "A static ETF analysis page for China AI semiconductor, optical-module and foundry-localization exposure through portfolio concentration and NAV context.",
        dataStatus: "Data As Of",
        latestClose: "Confirmed Close",
        feeLabel: "Fee / Distribution",
        viewState: "Current View",
        viewStateSub: "NAV and price gap check zone",
        chartEyebrow: "Price Action",
        ...
        viewStateValue: "Uptrend with NAV gap check",
        drivers: "Drivers",
        risks: "Risks",
        relevance: "Exposure",
    ...
    ja: {
        heroTitle: "KODEX China AI Semiconductor TOP10 ETF 分析",
        heroCopy: "中国AI半導体、光モジュール、ファウンドリ国産化テーマを、集中ポートフォリオとNAVの観点から見る静的ETF分析ページです。",
        dataStatus: "データ基準",
        latestClose: "確認済み終値",
        feeLabel: "費用 / 分配",
        viewState: "現在の見方",
        viewStateSub: "NAVと価格乖離の確認ゾーン",
        chartEyebrow: "Price Action",
        chartTitle: "ETF価格推移",
        profileEyebrow: "ETF Profile",
        ...
        support: "支持",
        resistance: "抵抗",
        viewStateValue: "上昇トレンド内でNAV乖離を確認",
        drivers: "ドライバー",
        risks: "リスク",
        relevance: "エクスポージャー",
        themeToggle: "テーマ切替"
